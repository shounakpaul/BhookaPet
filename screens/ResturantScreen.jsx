    ...
    <>
      ...
      <ScrollView>
        <View className="relative">
          ...
          >
            <ArrowLeftIcon size={20} color="#42adff" />
          </TouchableOpacity>
        </View>
          ...
          <View className="px-4 pt-4">
            ...
            <View className="flex-row my-1 space-x-2">
              <View className="flex-row items-center space-x-1">
                <StarIcon color="#42adff" opacity={0.8} size={22} />
            ...
            <Text className="text-black py-3 z-30">{short_description}</Text>
          </View>
